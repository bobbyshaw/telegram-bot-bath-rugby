...
class FixtureService {
     ...
     * @param {string[]} opposition - secondary team name
        ...
        return new Promise((resolve, reject) => {
            this.fetchAll(team)
                .then(fixtures => {
                    ...
                    var matchingFixtures = this._matchingFixtures(team, opposition, fixtures, isHome, isAway, true, false);
     ...
     * @param {string[]} opposition - Secondary team for fixture (optional)
